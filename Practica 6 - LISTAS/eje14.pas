...
{--------------------------------------------------------------------------------------------------------------------------}
  { modulos para inciso d}
	...
	begin
			usaOtroMedio:= ( (medioTransporte>=2) and (medioTransporte <=5) );
	end;
{--------------------------------------------------------------------------------------------------------------------------}
{--------------------------------------------------------------------------------------------------------------------------}
...
{--------------------------------------------------------------------------------------------------------------------------}
{--------------------------------------------------------------------------------------------------------------------------}
procedure recorrerVector ( v : vAlumnos); 
var
			vContador : vCont; 
			actual : listaViaje; 
			diaActual : rangoDias;
...
begin
	...
	inicializarVcontador(vContador); 
			...
			{recorro la lista del alumno mientras no este vacia, o mientras no se termine}
						while ( actual <> nil)  do   
							...
							{mientras no termine de procesar la lista del alumno, y mientras sea el mismo dia: }
									while ( (actual <>nil) and (actual^.elemento.dia = diaActual) ) do {mientras no termine de procesar al alumno y sea el mismo dia: }
											...
											{podria hacerlo en un modulo}
											case actual^.elemento.transporte of 
													1: precioTotal:= precioTotal + precio1 ;
													2: precioTotal:= precioTotal + precio2;
													3: precioTotal:= precioTotal + precio3;
													4:precioTotal:= precioTotal + precio4; 
												end; 
				...
				writeln ('La cantidad de alumnos que gastan mas de 80pesos por dia son: ',cantGasta); 
